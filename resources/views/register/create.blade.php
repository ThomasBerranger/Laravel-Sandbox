        ...
        <div class="grid grid-cols-1 gap-6 lg:gap-8">
            ...
            <div
                ...
                <div class="relative min-w-full">
                    <h2 class="text-xl text-center font-semibold text-gray-900 mb-3">Register</h2>
                    ...
                    <form method="post" action="{{ route('register.store') }}"
                        ...
                        <div class="flex justify-center items-center">
                            <button type="submit"
                                    class="bg-red-500 hover:bg-red-600 text-white rounded text-sm w-3/5 py-1">Register
                            </button>
                        </div>
                    </form>
